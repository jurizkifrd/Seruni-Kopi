      ...
      <div className="w-full h-[90vh] p-6 xl:p-10 max-md:overflow-y-scroll max-md:overflow-x-hidden max-md:relative xl:grid xl:grid-cols-[1.5fr_1fr]">
        <div className="xl:me-10">
          <ul className="w-full flex gap-4 justify-center items-center">
            ...
            <li className="w-max">
                <input type="checkbox" id="angular-option" name="category" value="Coffee" className="hidden peer" onChange={handleSelectedCategory} checked={selectedCategory === 'Coffee'}/>
                <label htmlFor="angular-option" className="inline-flex items-center justify-between w-full p-2 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                  Coffee
                </label>
            </li>
            <li className="w-max">
                <input type="checkbox" id="angular-option-1" name="category" value="Non Coffee" className="hidden peer" onChange={handleSelectedCategory} checked={selectedCategory === 'Non Coffee'}/>
                <label htmlFor="angular-option-1" className="inline-flex items-center justify-between w-full p-2 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                  Non Coffee
                </label>
            </li>
          </ul>
